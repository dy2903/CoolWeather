...
/*
 * 解析和处理返回的省市县数据:格式"代号|城市 , 代号|城市"
 * 解析返回的JSON数据
 * 存储到SharedPreferences里面.
 */
public class Utility {
	...
	public static void handleWeatherResponse(Context context, String response) {
		try {
			...
			Utility.saveWeatherInfo(context, cityName, weatherCode, temp1, temp2,
...
//		city_selected在ChooseAreaActivity中作为标志
